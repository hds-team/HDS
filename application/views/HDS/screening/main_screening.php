...
<div class="clear"></div>
    ...
    <div class="grid_1">
      <a href="<?php echo base_url('index.php/'.$this->config->item('sys_name').'/report/user_report'); ?>"><button aria-disabled="false" style="float:right;" class="da-button orange large">เพิ่มคำร้อง</button></a>
    </div>
<div class="clear"></div>

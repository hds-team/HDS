                    	...
                    	<div class="grid_4_center">
                        	<div id="manage" class="da-panel collapsible collapsed">
                                ...
                                <div class="da-panel-content">
									<form id="validate-WG" class="da-form" method="post" action="<?php echo base_url(); ?>index.php/UMS/showReport/setTime">
											...
											<div class="da-form-row">
												<div class="da-form-col-5-10">
													...
													<div class="da-form-item large">
														<input type="text" name="TimeFrom" id="TimeFrom" placeholder=""/>
													</div>
												</div>
												<div class="da-form-col-5-10">
													<label>ถึง<span class="required">*</span></label>
													<div class="da-form-item large">
														<input type="text" name="TimeTo" id="TimeTo" placeholder=""/>
													</div>
												</div>		
											</div>		

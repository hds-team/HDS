                        	...
                        	<div class="da-panel">
                            	<div class="da-panel-header">
                                	<span class="da-panel-title">
                                        ...
                                        <img src="<?php echo base_url(); ?>/images/icons/black/16/users.png" alt="" />กำหนดสิทธิ์ของกลุ่มงาน &nbsp &nbsp<?php echo $show['StNameT'];?> &nbsp &nbsp &nbsp(กลุ่มงาน<?php echo $show['GpNameT'];?>) &nbsp ของ <?php foreach($name as $name){ echo $name['UsName']; }?>
										<?php } ?>
									</span>
								...
								<form method="post" action="<?php echo base_url(); ?>index.php/UMS/perMissionP/upPer" >

...
<title>BUU Information System - Login</title>
	...
	<div id="da-login-box-wrapper">
    	...
    	<div id="da-login-box">
            ...
            <div id="da-login-box-content">
            	<form id="da-login-form" method="post" action="<?php echo base_url();?>index.php/gear/checklogin">
            ...
            <div id="da-login-box-footer">
            	<a href="index.php/UMS/forgotpassword/">forgot your password?</a>

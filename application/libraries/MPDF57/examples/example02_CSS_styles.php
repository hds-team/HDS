...
$html = "
<h1 color=\"#fff\" style=\"padding:5px 20px;background:-moz-linear-gradient(#0076c8,#0B4C5F);border-radius:20px 20px 20px 20px;font-size:18px;font-family:TH SarabunPSK;font-weight:bold;\">ประวัติ</h1>
...
$mpdf=new mPDF('th','A4', '0', 'TH SarabunPSK');

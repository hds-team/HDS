...
(function($) {
	$(document).ready(function(e) {
		...
		$("#Reg-base-dialog-GenTitle-div").dialog({
			autoOpen: false, 
			title: "ข้อมูลพื้นฐาน", 
			modal: true, 
			width: "900", 
		...
		$("#Reg-base-dialog-GenUniversity-div").dialog({
			autoOpen: false, 
			title: "ข้อมูลพื้นฐาน", 
			modal: true, 
			width: "900", 
		...
		$("#Reg-base-dialog-GenTombol-div").dialog({
			autoOpen: false, 
			title: "ข้อมูลพื้นฐาน", 
			modal: true, 
			width: "900", 
		...
		$("#Reg-base-dialog-GenCodePost-div").dialog({
			autoOpen: false, 
			title: "ข้อมูลพื้นฐาน", 
			modal: true, 
			width: "900", 
		...
		$("#Reg-base-dialog-GenCountry-div").dialog({
			autoOpen: false, 
			title: "ข้อมูลพื้นฐาน", 
			modal: true, 
			width: "900", 
		...
		$("#Reg-base-dialog-GenDistrict-div").dialog({
			autoOpen: false, 
			title: "ข้อมูลพื้นฐาน", 
			modal: true, 
			width: "900", 
		...
		$("#Reg-base-dialog-GenNation-div").dialog({
			autoOpen: false, 
			title: "ข้อมูลพื้นฐาน", 
			modal: true, 
			width: "900", 
		...
		$("#Reg-base-dialog-GenReligion-div").dialog({
			autoOpen: false, 
			title: "ข้อมูลพื้นฐาน", 
			modal: true, 
			width: "900", 
		...
		$("#Reg-base-dialog-GenProvince-div").dialog({
			autoOpen: false, 
			title: "ข้อมูลพื้นฐาน", 
			modal: true, 
			width: "900", 
		...
		/////////////NEW CREATE/////////
		$("#Reg-base-dialog-GenTitle").bind("click", function(event) {
			$("#Reg-base-dialog-GenTitle-div").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
		
		$("#Reg-base-dialog-GenUniversity").bind("click", function(event) {
			$("#Reg-base-dialog-GenUniversity-div").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
		
		$("#Reg-base-dialog-GenTombol").bind("click", function(event) {
			$("#Reg-base-dialog-GenTombol-div").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
		
		$("#Reg-base-dialog-GenCodePost").bind("click", function(event) {
			$("#Reg-base-dialog-GenCodePost-div").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
		
		$("#Reg-base-dialog-GenCountry").bind("click", function(event) {
			$("#Reg-base-dialog-GenCountry-div").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
		
		$("#Reg-base-dialog-GenDistrict").bind("click", function(event) {
			$("#Reg-base-dialog-GenDistrict-div").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
		
		$("#Reg-base-dialog-GenNation").bind("click", function(event) {
			$("#Reg-base-dialog-GenNation-div").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
		
		$("#Reg-base-dialog-GenReligion").bind("click", function(event) {
			$("#Reg-base-dialog-GenReligion-div").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
		
		$("#Reg-base-dialog-GenProvince").bind("click", function(event) {
			$("#Reg-base-dialog-GenProvince-div").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});

<?php
	$pic = '';
	$header = 'รายละเอียดมติการประชุมย่อ';
	$div = 'ส่วนราชการ';
	$no = 'ที่';
	$date = 'วันที่';
	$subject = 'เรื่อง';
...
<div style="font-size:16.0pt;font-family:'TH SarabunPSK','sans-serif';">
	...
	<p style="text-align:left;">
		<span class="emt-bottom-tab"><?php re_viewAgdtA($rs_ags, 0);?></span>
	</p>
	<p>
		<br/>
		<br/>
...
function re_viewAgdtA($child,$no=0){
	...
	foreach($child->result() as $row_child){
		...
		{
			$p = array("<p>", "</p>");
			echo "<div style=\"margin-left:".$margin2."px;\">".str_replace($p,"",$row_child->ags_detail)."</div>";
			$num1 = 0;
		}
		else
		{
		...
		if($row_child->ags_by != "")
		{
			echo "<br/><div style=\"margin-left:".$margin2."px;\">".$row_child->ags_by."</div><br/>";
		}
		
		if($row_child->ags_present != "")
		{
			echo "<table style=\"border:0px;font-size:16.0pt;font-family:'TH SarabunPSK','sans-serif';margin-top:0px;\">";
			echo "<tr>";
			echo "<td valign=\"top\" width=\"100\"><b><u>".$str_present."</u></b></td>";
			$p = array("<p>", "</p>");
			echo "<td>".str_replace($p,"",$row_child->ags_present)."</td>";
			echo "</tr>";
			echo "</table>";
			$num2 = 0;
		}
		...
		if($row_child->ags_result != "")
		{
			...
			$p = array("<p>", "</p>");
			echo "<td>".str_replace($p,"",$row_child->ags_result)."</td>";
			echo "</tr>";
			echo "<tr><td>&nbsp;</td></tr>";
			echo "</table>";
			$num3 = 0;
